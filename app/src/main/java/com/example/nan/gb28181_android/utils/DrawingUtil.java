 ...
 * @date 2019.6.8
 */
public class DrawingUtil extends Thread {
    ...
    public DrawingUtil(SurfaceHolder surfaceHolder, DisplayMetrics displayMetrics) {
    ...
    @Override
    public void run() {
        mLineWidth = (int) (displayMetrics.density * 1.5);
