...
#define FFMPEG_CONFIGURATION "--cross-prefix=arm-linux-androideabi- --sysroot=/usr/lib/android-ndk-r22b//toolchains/llvm/prebuilt/linux-x86_64/sysroot --prefix=/home/osboxes/Documents/mobile-ffmpeg-master/prebuilt/android-arm/neon/ffmpeg --pkg-config=/usr/bin/pkg-config --enable-version3 --arch=armv7-a --cpu=armv7-a --cc=armv7a-linux-androideabi24-clang --cxx=armv7a-linux-androideabi24-clang++ --extra-libs='-L/home/osboxes/Documents/mobile-ffmpeg-master/prebuilt/android-arm/neon/cpu-features/lib -lndk_compat' --target-os=android --enable-neon --enable-asm --enable-inline-asm --build-suffix=_neon --enable-cross-compile --enable-pic --enable-jni --enable-optimizations --enable-swscale --enable-shared --disable-encoders --enable-encoder=libx264 --enable-encoder=libx265 --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=h264 --enable-muxer=hevc --disable-decoders --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=h264_mediacodec --enable-decoder=hevc_mediacodec --enable-decoder=mpeg4 --disable-demuxers --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=rtp --enable-demuxer=rtsp --disable-parsers --enable-parser=h264 --enable-parser=hevc --disable-protocols --enable-protocol=file --enable-protocol=tcp --enable-protocol=udp --enable-protocol=rtp --enable-protocol=http --enable-protocol=hls --disable-filters --enable-avfilter --disable-bsfs --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-bsf=aac_adtstoasc --disable-iconv --disable-v4l2-m2m --disable-outdevs --disable-indevs --disable-avdevice --disable-symver --enable-small --disable-openssl --disable-xmm-clobber-test --disable-debug --enable-lto --disable-neon-clobber-test --disable-programs --disable-postproc --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --disable-sndio --disable-schannel --disable-securetransport --disable-xlib --disable-cuda --disable-cuvid --disable-nvenc --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-audiotoolbox --disable-appkit --disable-alsa --disable-cuda --disable-cuvid --disable-nvenc --disable-vaapi --disable-vdpau --enable-libx264 --enable-gpl --enable-libx265 --enable-gpl --disable-sdl2 --disable-zlib --enable-mediacodec"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/home/osboxes/Documents/mobile-ffmpeg-master/prebuilt/android-arm/neon/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/home/osboxes/Documents/mobile-ffmpeg-master/prebuilt/android-arm/neon/ffmpeg/share/ffmpeg"
