...
// nanuns add start
/**
 * Get value of the keyversion parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 */
#define osip_proxy_authorization_get_keyversion(header) osip_authorization_get_keyversion(header)
/**
 * Add the keyversion parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
#define osip_proxy_authorization_set_keyversion(header, value) osip_authorization_set_keyversion(header, value)
/**
 * Get value of the random1 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 */
#define osip_proxy_authorization_get_random1(header) osip_authorization_get_random1(header)
/**
 * Add the random1 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
#define osip_proxy_authorization_set_random1(header, value) osip_authorization_set_random1(header, value)
/**
 * Get value of the random2 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 */
#define osip_proxy_authorization_get_random2(header) osip_authorization_get_random2(header)
/**
 * Add the random2 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
#define osip_proxy_authorization_set_random2(header, value) osip_authorization_set_random2(header, value)
/**
 * Get value of the serverid parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 */
#define osip_proxy_authorization_get_serverid(header) osip_authorization_get_serverid(header)
/**
 * Add the serverid parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
#define osip_proxy_authorization_set_serverid(header, value) osip_authorization_set_serverid(header, value)
/**
 * Get value of the sign1 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 */
#define osip_proxy_authorization_get_sign1(header) osip_authorization_get_sign1(header)
/**
 * Add the sign1 parameter from a Proxy-Authorization element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
