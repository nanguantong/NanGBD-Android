...
// nanuns add start
/**
 * Get value of the random1 parameter from a Proxy-Authenticate element.
 * @param header The element to work on.
 */
#define osip_proxy_authenticate_get_random1(header) osip_www_authenticate_get_random1(header)
/**
 * Add the random1 parameter from a Proxy-Authenticate element.
 * @param header The element to work on.
 * @param value The value of the new parameter.
 */
#define osip_proxy_authenticate_set_random1(header, value) osip_www_authenticate_set_random1(header, value)
// nanuns add end
