...
struct osip_authorization {
  ...
  // nanuns add start
  char *keyversion; /**< keyversion (optionnal) */
  char *random1;    /**< random1 (optionnal) */
  char *random2;    /**< random2 (optionnal) */
  char *serverid;   /**< serverid (optionnal) */
  char *sign1;      /**< sign1 (optionnal) */
  // nanuns add end
};
