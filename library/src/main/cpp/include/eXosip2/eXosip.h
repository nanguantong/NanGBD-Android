...
// nanuns add start
#ifdef WIN32
typedef int(__stdcall *CbSign1)(const char *username, const char *random1, const char *random2, const char *serverid, char *sign1);
typedef int(__stdcall *CbNote)(const char *method, osip_message_t *msg);
#else
typedef int(*CbSign1)(const char *username, const char *random1, const char *random2, const char *serverid, char *sign1);
typedef int(*CbNote)(const char *method, osip_message_t *msg);
#endif
/**
 ...
 * @param serverid     server id (gm)
 * @param cb_sign1     sm2 sign1 callback (gm)
 * @param cb_note      note callback (gm)
 */
int eXosip_add_authentication_info_withgm(struct eXosip_t *excontext, const char *username, const char *userid, const char *passwd, const char *ha1, const char *realm, const char *serverid, CbSign1 cb_sign1, CbNote cb_note);
// nanuns add end
